...
public class PgOutputMessageDecoder extends AbstractMessageDecoder {
    ...
    private void handleRelationMessage(ByteBuffer buffer, TypeRegistry typeRegistry) throws SQLException {
		...
		try {
            ...
            LOGGER.info("customer info log,Schema: '{}', Table: '{}'", schemaName, tableName);
            LOGGER.info("customer info log,databaseMetadata:{}, tableId:{}, readColumns:{}", databaseMetadata, tableId, readColumns);
